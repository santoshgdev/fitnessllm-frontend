            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          safeSetState(() {});
                          _model.dataRunAPIResponse = await APIRouterCall.call(
                            authToken: currentJwtToken,
                            apiPayloadJson: _model.pageLevelApiPayload,
                          );

                          if ((_model.dataRunAPIResponse?.succeeded ?? true)) {
                            await showDialog(
                              context: context,
                  ...
                  StreamBuilder<List<StreamRecord>>(
                    stream: queryStreamRecord(
                      queryBuilder: (streamRecord) => streamRecord.where(
                        'type',
                        isEqualTo: 'strava',
                        isNull: ('strava') == null,
                      ),
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<StreamRecord> stravaStreamRecordList =
                          snapshot.data!;
                      final stravaStreamRecord =
                          stravaStreamRecordList.isNotEmpty
                              ? stravaStreamRecordList.first
                              : null;
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  if (stravaStreamRecord != null
                                      ? !stravaStreamRecord!.connected
                                      : true)
                                    InkWell(
                                  ...
                                  if (stravaStreamRecord != null ? true : false)
                                    Switch(
                                      value: _model.switchValue1 ??=
                                          stravaStreamRecord != null
                                              ? stravaStreamRecord!.connected
                                              : false,
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          stravaStreamRecord != null
                                              ? stravaStreamRecord?.lastUpdated
                                                  ?.toString()
                                              : 'Not Connected',
                                          'Not Connected',
                                        ),
                  ...
                  if (false)
                    FFButtonWidget(
                      onPressed: () {
                        print('ConnectNewService pressed ...');
                      },
