...
/// A page with lists of services you can connect to and a small space under
/// each with details that populate such last updated, counts, average, etc
...
class _IntegrationsWidgetState extends State<IntegrationsWidget> {
  ...
  void initState() {
    ...
    _model.switchValue1 = FFAppState().isStravaConnected;
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              if (!FFAppState().isStravaConnected)
                                InkWell(
                                  ...
                                  onTap: () async {
                                    await launchURL(
                                        'https://www.strava.com/oauth/authorize?client_id=144789&redirect_uri=http://dev.fitnessllm.app/strava-callback&response_type=code&scope=activity:read_all');
                                  },
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
